...
def index():
    ...
    inscripciones = conn.execute('''
        SELECT i.*, e.nombre, e.apellidos, c.descripcion 
        FROM inscripcion i
...
def add():
    ...
    if request.method == 'POST':
        ...
        conn.execute('''
        INSERT INTO inscripcion (fecha, estudiante_id, curso_id)
        VALUES (?, ?, ?)
    ...
    return render_template('inscripcion/add.html', 
...
def edit(id):
    ...
    conn.close()
    return render_template('inscripcion/edit.html',
